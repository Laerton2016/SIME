...
namespace SIME.Class.primitivo
{
    ...
    public class NetCliente
    {
        ...
        //Variáveis de dados 
        private List<InformacaoCredito> informacoes;
        private List<ContatosCliente> contatos;
        private List<IndicacoesCliente> indicacoes;
        ...
        public NetCliente()
        {
            ...
            //Variáveis de dados 
            Informacoes = new List<InformacaoCredito>();
            Contatos = new List<ContatosCliente>();
            Indicacoes = new List<IndicacoesCliente>();
        ...
        /// </summary>
        internal List<InformacaoCredito> Informacoes
        {
            get
            {
                return informacoes;
        ...
        /// Contatos do cliente
        /// </summary>
        public List<ContatosCliente> Contatos
        {
            get
            {
                return contatos;
        ...
        /// </summary>
        public List<IndicacoesCliente> Indicacoes
        {
            get
            {
                return indicacoes;
