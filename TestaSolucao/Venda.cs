...
namespace SIME
{
    public class Venda
    {
        ...
        public Int32 getCaixa() { return this.ID_caixa; }
        public Int32 getID_cliente() { return this.ID_cliente; }
        public Int32 getID_vendedor() { return this.ID_vendedor; }
        public DateTime getDataVenda() { return this.Data;}
        public Double getValor_especie() { return this.Especie; }
        public Double getValor_cheque() { return this.Cheque; }
        public Double getValor_Cartao() { return this.Cartao; }
        public Double getValor_promissoria() { return this.Vale; }
        public bool getVedaFechada() { return this.vendaFechada; }
        /// <summary>
        ...
        {
            return "ID = " + this.ID + "\n" +
                "ID Caixa = " + this.ID_caixa + "\n" +
                "ID Cliente = " + this.ID_cliente + "\n" +
                "ID Operador = " + this.ID_vendedor + "\n" +
                "Quantidade de itens = " + this.countItens() + "\n" +
                "Total venda: R$ " + this.Total.ToString("N") + "\n" +
                "Espécie: R$ " + this.Especie.ToString("N") + " " +
                "Cheque: R$ " + this.Cheque.ToString("N") + " " +
                "Promissoria: R$ " + this.Vale.ToString("N") + " " +
                "Cartão: R$ " + this.Cartao.ToString("N") + "\n" +
                "Data = " + this.Data.ToShortDateString() + "\n" +
                "Venda finalizada = " + this.vendaFechada;
