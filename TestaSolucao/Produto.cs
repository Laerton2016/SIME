...
namespace SIME.Class
{
    ...
    public class Produto : ITrataDados
    {
        ...
        public Double getValorVendaDesconto() { return this.valorVendaDesconto; }
        ...
        public void indexar()
        {
            ...
            {
                    item = new Produto(Convert.ToInt32(rsDadosSime.Fields["cod"].Value));
                    item.salvarSmall();
        ...
        private Produto jaCadastrado(String EAN)
        {
            ...
            if (!(RSdados.EOF || RSdados.BOF))
            {
                ...
                {
                    return new Produto(Convert.ToInt32(RSdados.Fields["cod"].Value));
                }
            }
            RSdados.Close();
            conex.Close();
